#train the model with no_enhancement model
...
for epoch in range(epoch_n):
    ...
    if test_epoch_acc >max_acc:
        torch.save(model,r'E:\论文\结果\无增强\\'+ 'no_noise.pt')
        max_acc = test_epoch_acc
train_acces=np.array(train_acces)
train_losses=np.array(train_losses)
test_acces=np.array(test_acces)
test_losses=np.array(test_losses)
np.save(r'E:\论文\结果\无增强\\'+'train_acces'+'.npy',train_acces)
np.save(r'E:\论文\结果\无增强\\'+'train_losses'+'.npy',train_losses)
np.save(r'E:\论文\结果\无增强\\'+'test_acces'+'.npy',test_acces)
np.save(r'E:\论文\结果\无增强\\'+'test_losses'+'.npy',test_losses)
