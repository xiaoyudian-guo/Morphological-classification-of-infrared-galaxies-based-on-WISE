...
for epoch in range(epoch_n):
    ...
    if test_epoch_acc > max_acc:
        torch.save(model, r'train result\vgg19\\' + 'vgg19.pt')
...
np.save(r'train result\vgg19\\'+'train_acces'+'.npy',train_acces)
np.save(r'train result\vgg19\\'+'train_losses'+'.npy',train_losses)
np.save(r'train result\vgg19\\'+'test_acces'+'.npy',test_acces)
np.save(r'train result\vgg19\\'+'test_losses'+'.npy',test_losses)
